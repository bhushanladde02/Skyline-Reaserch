...
public final class SkylineAlgorithm_RDF_SemiNaiv_Flags_V15 extends AbstractSkylineAlgorithm {

    private PointComparator_RDF comparator;
    private boolean usekmode = true;

    public SkylineAlgorithm_RDF_SemiNaiv_Flags_V15(PointComparator_RDF comparator) {
        super();
    ...
    public synchronized List<float[]> compute(PointSource data) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                float[] small_c = null;
                if (!failed) {
                    small_c = iter_compare.nextInTestButNotThis(iter_testMlooser.getDataNode());
                } else {
