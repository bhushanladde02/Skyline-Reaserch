...
public final class PointComparator_RDF_N1 implements PointComparator_RDF {

    private float delta = 0.2f;

    public PointComparator_RDF_N1(float delta) {
        this.delta = delta;
    }
    ...
    public String toString() {
        return "Comparator_RDF_N1(delta=" + delta + ")";
    }
