...
public class AlgorithmSummaryStatistics {
    ...
    protected double memoryConsumptionMB;

    public final static String HEADER =
	    "              trial |   #tuples | dim. | skyline size |   time (gen) |  time (sort) | time (pre) |  time (comp) | time (reorg) | comparisons | comp/tuple | time/comparison |       io cost |      datagen |";
    public final static String DIVIDER =
	    "--------------------+-----------+------+--------------+--------------+--------------+------------+--------------+--------------+-------------+------------+-----------------+---------------+--------------+";
    public final static String ENTRY =
	    "%19s | %9s | %4d | %12.0f | %9.2f ms | %9.2f ms | %7.2f ms | %9.2f ms | %9.2f ms | %11d | %10.1f | %12.2f ns | %13.0f | %12s |";
    ...
    public AlgorithmSummaryStatistics setMemoryConsumptionMB(double memoryConsumptionMB) {
